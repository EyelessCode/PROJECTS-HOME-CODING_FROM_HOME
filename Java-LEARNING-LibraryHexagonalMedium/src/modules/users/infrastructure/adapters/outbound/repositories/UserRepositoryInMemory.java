...
public class UserRepositoryInMemory implements IUserRepositoryOutpor{
    ...
    public UserRepositoryInMemory(){
        userMemory.put(new UserId(null), new User(new UserIc("097485296"), new UserName("Roberto"), new UserLastname("Albarado"), UserGender.M, new UserAge((byte)29)));
        userMemory.put(new UserId(null), new User(new UserIc("0985987874"), new UserName("Daniel"), new UserLastname("Mendoza"), UserGender.M, new UserAge((byte)23)));
        userMemory.put(new UserId(null), new User(new UserIc("0969963695"), new UserName("Lenin"), new UserLastname("Castillo"), UserGender.M, new UserAge((byte)41)));
        userMemory.put(new UserId(null), new User(new UserIc("0958852100"), new UserName("Esther"), new UserLastname("Verdezoto"), UserGender.F, new UserAge((byte)14)));
        userMemory.put(new UserId(null), new User(new UserIc("0990010147"), new UserName("Nicole"), new UserLastname("Demara"), UserGender.F, new UserAge((byte)21)));
    }
